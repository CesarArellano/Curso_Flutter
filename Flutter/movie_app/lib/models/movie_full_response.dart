...
//
//     final movieFull = movieFullFromMap(jsonString);
...
class MovieFullResponse {
  ...
  factory MovieFullResponse.fromJson(String str) => MovieFullResponse.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory MovieFullResponse.fromMap(Map<String, dynamic> json) => MovieFullResponse(
    adult: json["adult"],
